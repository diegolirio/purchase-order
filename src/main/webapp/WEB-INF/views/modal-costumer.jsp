...
<div class="modal fade" id="idAddCustomerModal" tabindex="-1" role="dialog" aria-labelledby="gridSystemModalLabel">
				                              ...
				                              <div class="panel-body">
													<form role="form" ng-submit="cFormCtrl.save(cFormCtrl.customer)">
					                                      <div class="row">
						                                      ...
						                                      <div class="col-md-2">
						                                          <label class="label label-default">Inscrição Estadual</label>
					...
					<div class="modal fade" id="idPhoneModal" tabindex="-1" role="dialog" aria-labelledby="gridSystemModalLabel">
					  <div class="modal-dialog modal-lg" role="document">
					    <div class="modal-content"> 
					      ...
					      <div class="modal-footer">
					        <button type="button" class="btn btn-default" ><i class="glyphicon glyphicon-plus"></i>  Adicionar</button>
					        <button type="button" class="btn btn-default" data-dismiss="modal">Fechar</button>
					      </div>
					    </div><!-- /.modal-content -->
					  </div><!-- /.modal-dialog -->
